...
function UserRouter() {
    ...
    // 2. accessToken이 없으면 -> 로그인페이지로 이동
    if (!accessToken) {
        return <h1>로그인페이지로 이동</h1>
    }

    // 3. accessToken이 만료? -> 재요청
...
    // 여기서 path는 products or cart이지 "/shop/products" or "/shop/cart"가 아님
...
    // Link -> 컴포넌트가 교체만 일어남: 상태가 유지
    return (
        <div>
            <h1>메인페이지</h1>
            <nav>
                {/* 하위 라우터 경로에 맞춰 Link 경로 수정 */}
